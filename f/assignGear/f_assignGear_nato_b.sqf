...
case "ctrgm":
{
	// LOADOUT: MEDIUM
	if (_loadout <= 1) then {
		_unit addBackpack _bagsmallctrg;
		clearMagazineCargoGlobal (unitBackpack _unit);
		(unitBackpack _unit) addItemCargoGlobal [_medkit,1];
		(unitBackpack _unit) addMagazineCargoGlobal [_smokegrenade, 4];
		(unitBackpack _unit) addItemCargoGlobal [_firstaid, 6];
	...
	// LOADOUT: HEAVY
	if (_loadout == 2) then {
		_unit addBackpack _bagmediumctrg;
		clearMagazineCargoGlobal (unitBackpack _unit);
		(unitBackpack _unit) addItemCargoGlobal [_medkit,1];
		(unitBackpack _unit) addMagazineCargoGlobal [_smokegrenade, 6];
		(unitBackpack _unit) addItemCargoGlobal [_firstaid, 12];
...
// BACKPACK: CTRG GRENADIER (CO/DC/SL/FTL/G)
case "ctrgg":
{
	// LOADOUT: LIGHT
	if (_loadout == 0) then {
	...
	if (_loadout == 1) then {
		_unit addBackpack _bagmediumctrg;
		clearMagazineCargoGlobal (unitBackpack _unit);
		(unitBackpack _unit) addMagazineCargoGlobal [_riflemagctrg, 4];
		(unitBackpack _unit) addMagazineCargoGlobal [_glmag, 2];
		(unitBackpack _unit) addMagazineCargoGlobal [_glsmokewhite, 2];
		(unitBackpack _unit) addMagazineCargoGlobal [_grenade, 2];
		(unitBackpack _unit) addMagazineCargoGlobal [_mgrenade, 2];
	...
	// LOADOUT: HEAVY
	if (_loadout == 2) then {
		_unit addBackpack _baglargectrg;
		clearMagazineCargoGlobal (unitBackpack _unit);
		(unitBackpack _unit) addMagazineCargoGlobal [_riflemagctrg, 6];
		(unitBackpack _unit) addMagazineCargoGlobal [_glmag, 4];
		(unitBackpack _unit) addMagazineCargoGlobal [_glsmokewhite, 4];
		(unitBackpack _unit) addMagazineCargoGlobal [_grenade, 4];
		(unitBackpack _unit) addMagazineCargoGlobal [_mgrenade, 4];
...
case "ctrgar":
{
	// LOADOUT: LIGHT
	if (_loadout == 0) then {
		_unit addmagazines [_ARmagCtrg_tr,2];
	};
	// LOADOUT: MEDIUM
	if (_loadout == 1) then {
		_unit addBackpack _bagsmallctrg;
		clearMagazineCargoGlobal (unitBackpack _unit);
		(unitBackpack _unit) addMagazineCargoGlobal [_ARmagCtrg, 2];
		(unitBackpack _unit) addMagazineCargoGlobal [_ARmagCtrg_tr, 2];
		(unitBackpack _unit) addMagazineCargoGlobal [_grenade, 1];
		(unitBackpack _unit) addMagazineCargoGlobal [_mgrenade, 1];
		(unitBackpack _unit) addMagazineCargoGlobal [_smokegrenade, 1];
	};
	...
	if (_loadout == 2) then {
		_unit addBackpack _bagmediumctrg;
		clearMagazineCargoGlobal (unitBackpack _unit);
		(unitBackpack _unit) addMagazineCargoGlobal [_ARmagCtrg, 4];
		(unitBackpack _unit) addMagazineCargoGlobal [_ARmagCtrg_tr, 4];
		(unitBackpack _unit) addMagazineCargoGlobal [_grenade, 2];(unitBackpack _unit) addMagazineCargoGlobal [_mgrenade, 2];
		(unitBackpack _unit) addMagazineCargoGlobal [_smokegrenade, 2];
	};
};
...
case "ctrgaar":
{
	...
	if (_loadout == 0) then {
		_unit addBackpack _bagsmallctrg;
		_unit addmagazines [_riflemagctrg,4];
		_unit addmagazines [_ARmag,2];
		_unit addmagazines [_grenade,1];_unit addmagazines [_mgrenade,1];
		_unit addmagazines [_smokegrenade,2];
	};
	...
	if (_loadout == 2) then {
		_unit addBackpack _baglargectrg;
		clearMagazineCargoGlobal (unitBackpack _unit);
		(unitBackpack _unit) addMagazineCargoGlobal [_riflemagctrg, 8];
		(unitBackpack _unit) addMagazineCargoGlobal [_ARmagCtrg, 4];
		(unitBackpack _unit) addMagazineCargoGlobal [_ARmagCtrg_tr, 2];
		(unitBackpack _unit) addMagazineCargoGlobal [_grenade, 3];(unitBackpack _unit) addMagazineCargoGlobal [_mgrenade, 3];
		(unitBackpack _unit) addMagazineCargoGlobal [_smokegrenade, 4];
...
// BACKPACK: CTEG RIFLEMAN (R)
case "ctrgr":
{
	// LOADOUT: LIGHT
	if (_loadout == 0) then {
		_unit addmagazines [_riflemagctrg,2];
		_unit addmagazines [_grenade,1];_unit addmagazines [_mgrenade,1];
		_unit addmagazines [_smokegrenade,2];
	};
	// LOADOUT: MEDIUM
	...
	if (_loadout == 2) then {
		...
		clearMagazineCargoGlobal (unitBackpack _unit);
		(unitBackpack _unit) addMagazineCargoGlobal [_riflemagctrg, 8];
		(unitBackpack _unit) addMagazineCargoGlobal [_riflemagctrg_tr, 4];
		(unitBackpack _unit) addMagazineCargoGlobal [_grenade, 4];
		(unitBackpack _unit) addMagazineCargoGlobal [_mgrenade, 4];
		(unitBackpack _unit) addMagazineCargoGlobal [_smokegrenade, 4];
	};
