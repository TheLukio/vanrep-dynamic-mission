...
_scope2 = "optic_Hamr";			// RCO Scope - 1x - 6x
_scope3 = "optic_SOS";			// SOS Scope - 18x - 7
...
_glflarepurple = "3Rnd_UGL_FlarePurple_F";
...
_smokegrenadewhite = "SmokeShellWhite";
...
_sfhelmet = ["H_Booniehat_dgtl","H_Cap_blk_Raven"];
_sfRig = _mediumRig;
...
if (_isMan) then {
	...
	_unit addItemToUniform _pistolmag;		// Add a single _pistolmag
	_unit addItemToUniform _chemgreen;        // Add a single _chemblue
	...
	case "crate_small":
{
		...
		_unit addMagazineCargoGlobal [_smokegrenadegreen, 2];
		_unit addItemCargoGlobal [_firstaid, 6];
		_unit addItemCargoGlobal ["MineDetector",10];
		_unit addItemCargoGlobal ["ToolKit",10];				
};
