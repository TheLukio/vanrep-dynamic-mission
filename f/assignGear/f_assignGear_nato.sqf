...
_silencer3 = "muzzle_snds_B";	// 7.62 suppressor

_scope1 = "optic_Holosight";	// Holosight
_scope2 = "optic_Hamr";			// MRCO Scope - 1x - 6x
_scope3 = "optic_SOS";			// SOS Scope - 18x - 75x
_scope4 = "optic_ARCO";			// ARCO sight

_bipod1 = "bipod_01_F_snd";		// Default bipod
_bipod2 = "bipod_02_F_blk";		// Black bipod

// Default setup
 // The default attachment set for most units, overwritten in the individual unitType
...
_rifle = "arifle_MX_F";
_rifleBlack = "arifle_MX_Black_F";
_rifleCtrg = "arifle_Mk20_plain_F";
_riflemag = "30Rnd_65x39_caseless_mag";
_riflemag_tr = "30Rnd_65x39_caseless_mag_Tracer";
_riflemagctrg = "30Rnd_556x45_Stanag";
_riflemagctrg_tr = "30Rnd_556x45_Stanag_Tracer_Red";

// Standard Carabineer (Medic, Rifleman (AT), MAT Gunner, MTR Gunner, Carabineer)
_carbine = "arifle_MXC_F";
_carbineBlack = "arifle_MXC_Black_F";
_carbineCtrg = "arifle_Mk20C_plain_F";
...
_glrifleBlack = "arifle_MX_GL_Black_F";
_glrifleCtrg = "arifle_Mk20_GL_plain_F";
...
_pistolctrg = "hgun_P07_F";
_pistolmagctrg = "16Rnd_9x21_Mag";
...
_bagsmallctrg = "B_AssaultPack_rgr";
_bagmediumctrg = "B_Kitbag_cbr";
_baglargectrg = "B_Carryall_cbr";
...
_AR = "arifle_MX_SW_F";
_ARBlack = "arifle_MX_SW_Black_F";
_ARmag = "100Rnd_65x39_caseless_mag";
_ARmag_tr = "100Rnd_65x39_caseless_mag_Tracer";

_ARCtrg = "LMG_Mk200_F";
_ARmagCtrg = "200Rnd_65x39_cased_Box";
_ARmagCtrg_tr = "200Rnd_65x39_cased_Box_Tracer";
...
_DMrifle = "arifle_MXM_F"; // MXM
_DMriflemag = "30Rnd_65x39_caseless_mag";

// Recon Marksman rifle
_RDMrifle = "srifle_EBR_F";
_RDMriflemag = "20Rnd_762x51_Mag";
...
_crew = ["vc","vg","vd"];
_ghillie = ["sn","sp"];
_specOp = ["reconftl","reconuav","recondm","reconm"];
_ctrg = ["ctrgftl","ctrgrm","ctrgrat","ctrgar","ctrgaar","ctrggl","ctrgm"];

// Basic clothing
// The outfit-piece is randomly selected from the array for each unit
_baseUniform = ["U_B_CombatUniform_mcam","U_B_CombatUniform_mcam"];
_baseHelmet = ["H_HelmetSpecB_snakeskin","H_HelmetSpecB_snakeskin"];
_baseGlasses = [];

// Vests
_lightRig = ["V_BandollierB_cbr","V_BandollierB_cbr"];
_mediumRig = ["V_PlateCarrier2_rgr","V_PlateCarrier2_rgr"]; 	// default for all infantry classes
_heavyRig = ["V_PlateCarrier3_rgr"];

// Diver
_diverUniform =  ["U_B_survival_uniform"];
_diverHelmet = ["H_Watchcap_camo"];
...
// Spec Op
//_sfuniform = ["U_B_SpecopsUniform_sgg"]; // Recon MTP
// _sfuniform = ["U_I_G_Story_Protagonist_F"]; // Black top mtp pants
_sfuniform = ["U_C_WorkerCoveralls"]; // Black pants light top
_sfhelmet = ["H_HelmetSpecB_blk"];
// _sfrig = ["V_PlateCarrier2_rgr"]; // coyote light chest rig
_sfrig = ["V_PlateCarrier1_blk"]; // black light chest rig
_sfglasses = ["G_Bandanna_tan"];

// CTRG

_ctrguniform = ["U_B_CTRG_3", "U_B_CTRG_1"]; // Black pants light top
_ctrghelmet = ["H_HelmetB_camo"];
_ctrgrig = ["V_PlateCarrierL_CTRG"]; // black light chest rig
...
if (_isMan) then {
	...
	_unit linkItem _nvg;	// Add and equip NvG
	_unit addmagazine _pistolmag;
	_unit addweapon _pistol;
	_unit addItemToUniform _firstaid;		// Add a single first aid kit (FAK)
	_unit addItemToUniform _firstaid;		// Add a single first aid kit (FAK)	
	_unit addItemToUniform _firstaid;		// Add a single first aid kit (FAK)		
	_unit addItemToUniform _pistolmag;		// Add a single _pistolmag
	_unit addItemToUniform _pistolmag;		// Add a single _pistolmag
	_unit addItemToUniform _chemblue;        // Add a single _chemblue
...
// LOADOUT: Recon UAV
	case "reconuav":
	{
		...
		_unit addweapon _carbineBlack;
		_unit addmagazines [_glsmokewhite,2];
		_attachments = [_attach1,_scope2,_silencer2];		
		["uav"] call _backpack;
	};		

// LOADOUT: Recon Dedicated Marksman
	case "recondm":
	{
		_unit addmagazines [_RDMriflemag,7];
		_unit addweapon _RDMrifle;
		_unit addmagazines [_glsmokewhite,2];
		_attachments = [_attach1,_scope3,_silencer3];		
		//["reconDM"] call _backpack;
	};
...
// LOADOUT: CTRG TL
	case "ctrgftl":
	{
		_unit addmagazines [_riflemagctrg,7];
		_unit addmagazines [_riflemagctrg_tr,2];
		_unit addweapon _glrifleCtrg;
		_unit addmagazines [_glmag,6];
		_unit addmagazines [_glsmokewhite,2];
		_attachments = [_attach2,_scope4];		
		["ctrgg",2] call _backpack;
	};	
...
// LOADOUT: CTRG RM
	case "ctrgrm":
	{
		_unit addmagazines [_riflemagctrg,7];
		_unit addmagazines [_riflemagctrg_tr,2];		
		_unit addweapon _rifleCtrg;
		_unit addmagazines [_glsmokewhite,2];
		_attachments = [_attach2,_scope1];		
		["ctrgr",0] call _backpack;		
	};		
...
// LOADOUT: CTRG GL
	case "ctrggl":
	{
		...
		_unit addmagazines [_glsmokewhite,2];
		_attachments = [_attach2,_scope1];
		["ctrgg",1] call _backpack;
	};			
	
// LOADOUT: CTRG Autorifleman
	case "ctrgar":
	{
		_unit addmagazines [_ARmagCtrg,3];
		_unit addweapon _ARCtrg;
		_unit addmagazines [_glsmokewhite,2];
		_attachments = [_attach2,_scope1];
		["ctrgar",1] call _backpack;
	};

// LOADOUT: CTRG Assistant Autorifleman
	case "ctrgaar":
	{
		_unit addmagazines [_riflemagctrg,7];
		_unit addweapon _rifleCtrg;
...
// LOADOUT: CTRG Medic	
	case "ctrgm":
	{
		_unit addmagazines [_riflemagctrg,7];
		_unit addmagazines [_riflemagctrg_tr,2];
		_unit addweapon _carbineCtrg;
		_unit addmagazines [_glsmokewhite,2];
		_attachments = [_attach2,_scope1];
		["ctrgm",2] call _backpack;
