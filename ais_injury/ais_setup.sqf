...
tcb_ais_rambofactor 			= 	1.5; 				// A higher value means more damage tolerance. Set to 2 for double damage tolerance. Set to 0.5 for half etc. 1 equates to Vanilla.
...
tcb_ais_allways_walk 			= 	true; 			// If set to true, the units are always able to walk/run. False means broken legs are possible (Vanilla).
